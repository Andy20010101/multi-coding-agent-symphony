...
- Invalid fixture coverage for unsafe refs, duplicate task ids, empty acceptance, unknown roles, unknown event types, missing copy-only prompt text, and dry-run/confirm inconsistency.
