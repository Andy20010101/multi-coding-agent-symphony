...
| PR-4 acceptance and closeout snapshot | Draft PR from `codex/v47-acceptance-closeout-snapshot` | `codex/v47-acceptance-closeout-snapshot` | Pending | Pending | `docs/qa/v47-mac-app-shell-activation-acceptance.md`, this snapshot |
