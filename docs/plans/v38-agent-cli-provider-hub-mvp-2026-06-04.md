...
- task-2: Provider health check API. Read-only health state only; no model invocation.
- task-3: Capability profile mapping. Map contract fields to capability previews; no real runner.
